Description of App: An app that allows users to input a twitter account's username and then view the account's tweets, account's followers, and account's friends.  
